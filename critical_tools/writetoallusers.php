...
// Access from webdir with: writetoallusers.php?k=LONGWRITERSKEY
...
$canned_email = "vitalallusernotice"; // Slug from the "pantry" table to select the canned email
$subject_suffix = " - badAd Update"; // Appends the canned email Subject
$payload_content = $messageBody; // Middle of the Body, after the canned email and before the salutation
$footer_link_content = "";

echo "<br />Sending message to all users:<br />
time: $timeNow<br />
