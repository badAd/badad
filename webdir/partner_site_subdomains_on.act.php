...
// _POST the site ID
if ((isset($_POST['s'])) && (preg_match ('/[^a-zA-Z0-9]$/i', $_POST['s']))) {$IP = get_ip_addr(); script_kiddy('sk_61', '_POST s', $_POST['s'], $IP);}
...
$q = "UPDATE partnersites SET allow_subdomain=true WHERE id='$site_id'";
