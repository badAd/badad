...
$q = "SELECT time_date FROM downloaded_ad_analytics WHERE ad_id='$adID' ORDER BY time_date";
$r = mysqli_query ($agg_dbc, $q);
// Activity check
if (mysqli_num_rows($r) == 0) {
	echo "
...
// Clicks
// Loop through each entry in the date range and put them into an array
$q = "SELECT time_date FROM clicked_ad_analytics WHERE ad_id='$adID' ORDER BY time_date";
