...
if ((!isset($_GET['c'])) || (!isset($_SESSION['editing_id'])) || (!isset($_SESSION['editing_status']))) {
...
echo '<br />
  ...
  if ($new_ad_biz_listing == 'biz') {
    echo '"edit_ad.php?c='.$cat.'&b"';
  } elseif ($new_ad_biz_listing == 'non') {
    echo '"edit_ad.php?c='.$cat.'"';
  }

  echo ' method="post" accept-charset="utf-8" style="padding-left:100px">
  ...
  // Subcategory
    ...
    if ((isset($_POST['subcat'])) && (preg_match ('/[^a-zA-Z0-9]$/i', $_POST['subcat']))) {$IP = get_ip_addr(); script_kiddy('sk_12', '_POST subcat', $_POST['subcat'], $IP);}
    ...
    // Runs until
  echo '<br /><br />
    <b class="weekslong">Until: '.$_SESSION['new_ad_date_expires'].'</b>';
