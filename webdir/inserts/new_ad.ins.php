...
echo '
<form method="get" action="new_ad.php" id="new_ad_form">
</form>
<table class="startselect">
<tbody>
<colgroup>
  <col style="width: 33%" />
  <col style="width: 33%" />
...
<tr><td colspan="3"><p class="startinstructions">First, choose a category...</p></td></tr>
<tr><td></td><td>
<select class="startselect" name="c" form="new_ad_form">
  <option disabled selected hidden>Choose &hellip;&nbsp;&#8964;</option>';

$q = "SELECT slug, category FROM categories";
$r = mysqli_query($dbc, $q);
while ($row = mysqli_fetch_array($r)) {
  $catSlug = $row[0];
  $catName = $row[1];
  echo '<option value="'.$catSlug.'">'.$catName.'</option>';
}

$q = "SELECT price, bizn_price, pdcst_price, pdcst_renew FROM categories LIMIT 1";
$r = mysqli_query($dbc, $q);
while ($row = mysqli_fetch_array($r)) {
  $catPrice = $row[0];
  $biznPrice = $row[1];
...
<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td colspan="3"><p class="startinstructions">Next, choose a package...</p></td></tr>
<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr>
  <td>
  <p style="text-align: center;" class="startexample_ad"><b class="badad_ad">Example Text Ad Title</b><br class="badad_ad"><span class="badad_ad descr">One line about my ad</span><br class="badad_ad"><em class="badad_ad">list, some, different, things, here</em><br class="badad_ad"><span class="badad_ad price">Email us for pricing</span> <a class="badad_ad" rel="nofollow" href="#"><u class="badad_ad">Contact</u></a></p>

  </td><td>
  <p style="text-align: center;" class="startexample_ad"><b class="badad_ad">Example Text Ad Title</b><br class="badad_ad"><span class="badad_ad descr">One line about my ad</span><br class="badad_ad"><em class="badad_ad">list, some, different, things, here</em><br class="badad_ad"><span class="badad_ad price">Email us for pricing</span> <a class="badad_ad" rel="nofollow" href="#"><u class="badad_ad">Contact</u></a><br class="badad_ad"><b class="badad_ad badad_ad_content_bizn">|<i class="badad_ad badad_ad_content_bizn"> DBA / Brand Name </i>|</b></p>
  </td><td>
  <p style="text-align: center;" class="startexample_ad"><b class="badad_ad">Example Text Ad Title</b><br class="badad_ad"><span class="badad_ad descr">One line about my ad</span><br class="badad_ad"><em class="badad_ad">list, some, different, things, here</em><br class="badad_ad"><span class="badad_ad price">Email us for pricing</span> <a class="badad_ad" rel="nofollow" href="#"><u class="badad_ad">Contact</u></a><br class="badad_ad"><b class="badad_ad badad_ad_content_bizn">|<i class="badad_ad badad_ad_content_bizn"> DBA / Brand Name </i>|</b></p>
  </td>
</tr>
<tr><td><p class="starthighlight"><b>✓ Text ad</b></p></td><td><p class="starthighlight"><b>✓ Text ad</b></p></td><td><p class="starthighlight"><b>✓ Text ad</b></p></td></tr>
<tr>
  <td><ul class="startdetails"><li>Ad runs until set time, not limited by clicks or views</li><li>Distributed across our network of blog &amp; app partners</li><li>Limited to 8 weeks per run</li><li>Can schedule re-run when ad finishes</li><li>Download statistics in XML file</li></ul></td>
  <td><ul class="startdetails"><li>Ad runs until set time, not limited by clicks or views</li><li>Distributed across our network of blog &amp; app partners</li><li>Limited to 53 weeks per run</li><li>Can schedule re-run when ad finishes</li><li>Download statistics in XML file</li><li>Access to graphic statistics</li><li>Can edit ad every 8 weeks</li><li>Listed in <i>Business</i> filter at badAd</li><li>Extra <b>Brand Name</b> line in bold</li></ul></td>
  <td><ul class="startdetails"><li>Ad runs until set time, not limited by clicks or views</li><li>Distributed across our network of blog &amp; app partners</li><li>Limited to 53 weeks per run</li><li>Can schedule re-run when ad finishes</li><li>Download statistics in XML file</li><li>Access to graphic statistics</li><li>Can edit ad every 8 weeks</li><li>Listed in <i>Business</i> filter at badAd</li><li>Extra <b>Brand Name</b> line in bold</li></ul></td>
</tr>
<tr><td></td><td></td><td><p class="starthighlight"><b>✓ Podcast ad</b></p><ul class="startdetails"><li>Ad runs until set time, not limited by clicks or downloads</li><li>Distributed across our network of podcast partners</li><li>50 word manuscript</li><li>30 second recording by our team</li><li>Can re-use recording for future ads at lower cost</li></ul></td></tr>
<tr>
  <td>
    <input type="submit" form="new_ad_form" name="n" value="Normal" class="startselect" /><br /><br />
  </td><td>
    <input type="submit" form="new_ad_form" name="b" value="Business" class="startselect" /><br /><br />
  </td><td>
    <input type="submit" form="new_ad_form" name="p" value="Podcast" class="startselect" /><br /><br />
  </td>
</tr>
<tr>
  <td>
    <p>$'.$catPrice.' per week<br /></p>
  </td><td>
    <p>$'.$biznPrice.' per week<br /></p>
  </td><td>
    <p>$'.$podcstFirstWeek.' first week<br /></p>
  </td>
</tr>
<tr>
  <td></td><td></td>
  <td>
    <p><i class="note_gray">$'.$pdcstRenew.' per week after</i></p>
  </td>
</tr>
</tbody>
</table>
...
echo '<br />
  ...
  if ($new_ad_pod_listing == 'pod') {
    echo '<b class="adcontentform">Category & Rate:</b><br /><br />
  ...
  if ($new_ad_biz_listing == 'biz') {
    if (isset($userid)) {
      echo '
      <b class="adcontentform">Wait to run this ad until another ad ends:</b> <i class="note_gray">(optional)</i><br /><br />
  ...
  // Subcategory
    echo '<b class="adcontentform">Subcategory:</b><br /><br />
    ...
    echo '<br /><br /><p class="note_gray"><i>Subcategories help three ways:</i></p>
    <ol>
      <li><i class="note_gray">1. Advertising partners can choose which Subcategories (not Tags) to include on their websites.</i></li>
      <li><i class="note_gray">2. Visitors can search badAd.one by Subcategory (or Tag).</i></li>
      <li><i class="note_gray">3. Every ad must have a unique Heading, Contact URL, and Business Name (if applicable,) but, if you want to purchase the same ad more than once (for more exposure,) you are allowed to run an identical ad, <b>if the Subcategory is different</b>.</i></li>
    </ol>
    <p class="note_gray"><i>If you don\'t see a Subcategory you like, choose something close, then use a Tag (very bottom) for what you wanted.</i></p>';

    // Role
    echo '
      <b class="adcontentform">Advertising as:</b><br /><br />
    ...
    // Weeks long
  echo '<br /><br />
    <b class="adcontentform">For:</b><br /><br />
    ...
    // Start creating the "Weeks long" select option
      ...
      if (isset($wl_value)) {
				echo '<option disabled value="" hidden>How many &nbsp;</option>';
			} else {
				echo '<option disabled value="" selected hidden>How many &nbsp;</option>';
			}
    ...
    // Nickname
    echo '<b class="adcontentform">Nickname:</b> <i class="note_gray">(for your reference)</i><br /><br />';
    ...
    if ($new_ad_pod_listing == 'pod') {
      ...
      No copyright claims can be made for any content submitted on this page as a result of appearing in ads delivered through badAd.one or its affiliates, whether as podcast ads, text ads, or otherwise.</i></small><br />';
    }

    // Text ad content
    echo '<br />
          <b class="adcontentform">Your text ad content:</b><br />';
    ...
    echo '<label for="cntc"><b class="adcontentform">Contact URL:</b></label><br />';
    create_new_ad_input('cntc', 'url', 'https://...', $reg_errors, $new_ad_contactURL);
    echo '<br />';

    echo '<label for="taglist"><b class="adcontentform">Tags:</b> <i class="note_gray">(spaces will be removed, letters & numbers only, separate by commas)</i></label><br />';
