...
$q = "SELECT date_dead, useable, userid FROM confirmchange WHERE binary temppass='$tempURLpass' AND useable='live'";
...
if (($timeNow < $datedead) && ($usable == 'live')) {
  ...
  $rformaction = 'info_repair.php?r='.$tempURLpass; // This must be set for the include to work
  include ('includes/info_repair_form.inc.php');
