...
// _POST the userid
if ((isset($_POST['s'])) && (preg_match ('/[^a-zA-Z0-9]$/i', $_POST['s']))) {$IP = get_ip_addr(); script_kiddy('sk_63', '_POST s', $_POST['s'], $IP);}
...
$q = "UPDATE partnersites SET useable='off' WHERE user_id='$userid'";
